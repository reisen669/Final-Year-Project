# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 15:51:16 2019
@author: Hor Sui Lyn 1161300122

This script is for ResNet50_V2 model training of Methods 1 and 2
...
FT = 20 # Only affects Method 2 (20, 30, 50)
NAME = "ResNet50_V2: "
...
# Method 1: resnet50_randomx_20_1, resnet50_randomx1_20_1, resnet50_randomx2_20_1
# Method 2: resnet50_randomft20_20_1, resnet50_randomft30_20_1, resnet50_randomft50_20_1
...
if PRETRAINED: # for Method 2 
    base_model=ResNet50V2(weights='imagenet', include_top=False, input_shape=(IMG_SIZE, IMG_SIZE, 3)) #imports the resnet50 model and discards the last 1000 neuron layer.
else: # for Method 1
    base_model=ResNet50V2(weights=None, include_top=False, input_shape=(IMG_SIZE, IMG_SIZE, 3)) #imports the resnet50 model and discards the last 1000 neuron layer.

# unfreeze all layers 
base_model.trainable = True

# print number of layers in base model
print("Number of layers in the base model: ", len(base_model.layers)) # 190 for resnet50v2
